  ...
  const events: Event[] = [
    {
      ...
      ticketTypes: [
        { id: 'tt-trad-standard', eventId: 'evt-trad-dance-2026', name: 'Standard Ticket', price: 1000, totalQuantity: 300, soldQuantity: 142, description: 'Standard event access with general lawn seating.', benefits: ['Full event access', 'Lawn seating'], status: 'ACTIVE', createdAt: now(), updatedAt: now() },
        { id: 'tt-trad-premium', eventId: 'evt-trad-dance-2026', name: 'Premium Ticket', price: 2000, totalQuantity: 150, soldQuantity: 88, description: 'Front circle amphitheatre seating with fast-track entry.', benefits: ['Priority entrance', 'Front circle seating'], status: 'ACTIVE', createdAt: now(), updatedAt: now() },
        { id: 'tt-trad-vip', eventId: 'evt-trad-dance-2026', name: 'VIP Experience', price: 3000, totalQuantity: 50, soldQuantity: 32, description: 'Exclusive hospitality tent with meet & greet.', benefits: ['VIP hospitality lounge', 'Meet & greet with Coopstar'], status: 'ACTIVE', createdAt: now(), updatedAt: now() },
      ],
      createdAt: now(),
      updatedAt: now(),
    },
    {
      ...
      faqs: [],
      ticketTypes: [
        { id: 'tt-mod-standard', eventId: 'evt-modern-dance-2026', name: 'Standard Ticket', price: 1000, totalQuantity: 200, soldQuantity: 75, description: 'Access to general viewing floor.', benefits: ['Auditorium entrance', 'Public dance sessions'], status: 'ACTIVE', createdAt: now(), updatedAt: now() },
        { id: 'tt-mod-premium', eventId: 'evt-modern-dance-2026', name: 'Premium Pass', price: 2000, totalQuantity: 100, soldQuantity: 44, description: 'Reserved tiered bleacher seating.', benefits: ['Tiered premium seats', 'Warm-up access'], status: 'ACTIVE', createdAt: now(), updatedAt: now() },
        { id: 'tt-mod-vip', eventId: 'evt-modern-dance-2026', name: 'VIP Backstage Supporter', price: 3000, totalQuantity: 50, soldQuantity: 20, description: 'Front stage box and official crew badge.', benefits: ['Front stage lounge', 'Complimentary refreshments'], status: 'ACTIVE', createdAt: now(), updatedAt: now() },
      ],
      createdAt: now(),
      updatedAt: now(),
    },
    {
      ...
      faqs: [],
      ticketTypes: [
        { id: 'tt-summer-standard', eventId: 'evt-summer-fest-2026', name: 'Standard Ticket', price: 1000, totalQuantity: 350, soldQuantity: 120, description: 'All-day festival entry.', benefits: ['Festival access', 'Field games'], status: 'ACTIVE', createdAt: now(), updatedAt: now() },
        { id: 'tt-summer-premium', eventId: 'evt-summer-fest-2026', name: 'Premium Explorer', price: 2000, totalQuantity: 180, soldQuantity: 85, description: 'Includes craft kit and face painting.', benefits: ['Craft materials', 'Face painting'], status: 'ACTIVE', createdAt: now(), updatedAt: now() },
        { id: 'tt-summer-vip', eventId: 'evt-summer-fest-2026', name: 'VIP Family Pass', price: 3000, totalQuantity: 70, soldQuantity: 38, description: 'Shaded VIP canopy and lunch voucher.', benefits: ['Canopy lounge', 'Lunch included'], status: 'ACTIVE', createdAt: now(), updatedAt: now() },
      ],
      createdAt: now(),
      updatedAt: now(),
    },
